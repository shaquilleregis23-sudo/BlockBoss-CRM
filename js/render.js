...
<div class="card" style="border-color:rgba(88,166,255,.3)"><h3>🛟 Support & Reliability</h3><p class="sub">Send a traceable support request with release, device, sync queue, and account context attached automatically.</p><div class="action-grid"><button class="green" data-action="supportCenter">Contact Support</button><button class="blue" data-action="healthDashboard">Production Health</button><button class="gold" data-action="activationCenter">Activation Center</button></div></div>
