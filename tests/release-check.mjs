...
ok(read('ops/release-gate.github-actions.yml').includes('test:e2e')&&read('ops/release-gate.github-actions.yml').includes('test:load'),'GitHub runs browser and scale gates on every main release');
